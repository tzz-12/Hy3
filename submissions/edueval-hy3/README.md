...
| 至少跑通 2 个端到端 demo 流程 + ≤2 min 视频 | 3 条流程：① 好样本 PASS ② 公式错误被规则层 0.5 秒拦截 FAIL ③ 伪启发包装被维度 9 判低分；演示视频见独立仓库 [`docs/demo.mp4`](https://github.com/tzz-12/edu-eval-hy3/blob/main/docs/demo.mp4)（94 秒，README 首页内嵌可直接播放） |
